<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="top-0 left-0 z-40 fixed w-full border-t-8 border-orange-500">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-6">
        <div>
          <g-link to="/" @click.native="scrollToTop">
            <div class="site-logo" v-html="siteName"></div>
          </g-link>
        </div>
    ...
    <footer class="bg-orange-500 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-6">
        <div class="mb-8 lg:mb-0">
          <div>Made with <span class="mr-2">❤</span>️ in Chennai, India.</div>
        </div>
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:xqsit94@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/xqsit94" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/xqsit94" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/xqsit94" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://linkedin.com/in/xqsit94" target="_blank" class="text-white hover:text-gray-400">
              <svg width="22" height="22" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z" /></svg>
            </a>
          </li>
        </ul>
      </div>
...
export default {
  ...
  computed: {
    siteName: function () {
      ...
      const index = siteName.indexOf('k');
      const first = siteName.substr(0, index);
      const last = siteName.substr(index);
      return `${first}<span class="sub-logo">${last}</span>`
    }
  },
  methods: {
    scrollToTop() {
